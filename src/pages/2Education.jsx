            ...
            <div className={styles.course_work}>
              <div className={styles.school_information}>
                <img
                  ...
                  src={require('../images/tuftsemblem.png')}
                  alt=""
                />
                <div className={styles.school_description}>
                  ...
                  <p className={styles.italics} id={styles.info}>
          ...
          <div className={styles.school_accomplishments}>
            <div className={styles.course_work}>
              <div className={styles.school_information}>
                <img
                  className={styles.logo}
                  src={require('../images/saslogo.png')}
                  alt=""
                />
                <div className={styles.school_description}>
                    ...
                    <tr>
                      ...
                      <th>
                        <p id={styles.description}>
                          Organized practice sets, taught problem solving
                          strategies, and organized Pi Week: a week of original
                          math activities for all students with pie prizes.
                        </p>
                      </th>
                    </tr>
                    <tr>
                      <th id={styles.ec_name}>Link Crew Leader</th>
                      <th id={styles.description}>
                        Applied and was chosen as one of 30 leaders. Helped
                        freshman transition into high school by leading and
                        advising my group of 8 throughout the year.
                      </th>
                    </tr>
                    <tr>
                      ...
                      <th id={styles.description}>
                        <p>
                          Responsible for creating statistics-tracking
                          spreadsheets, attending games and preparing game
                          reports.
                        </p>
                      </th>
                    </tr>
                ...
                <table className={styles.award_table}>
                  <tbody>
                    <tr>
                      ...
                      <th>
                        <p id={styles.award_name}>
                          Purple Comet - 1st Place Team in China
                        </p>
                        <p id={styles.description}>
                          90 minute team competition administered at school,
                          worldwide Honorable Mention
                        </p>
                      </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <th>
                        <p id={styles.award_name}>
                          ASDAN Math Tournament - 2nd Place Team
                        </p>
                        <p id={styles.description}>
                          Travelled to Beijing and placed 2nd overall out of 80+
                          teams in China (640+ people)
                        </p>
                      </th>
                    </tr>
                  </tbody>
