    ...
    this.state = {
      projects: [
        ...
        },
        {
          ...
          description:
            'I placed 1st out of 76 participants in an ACII art challenge to celebrate the 50th anniversary of Apollo 11 I used a combination of hardcoded ASCII art, dynamically generated ASCII animation from existing footage of rotating Earth, and existing photos with mathematical transformations performed upon them.',
        },
        {
          image: Topcoder,
          ...
          description:
            'I participated in a 20-day long online hazard detection competition as my first project in freelance coding. I recieved footage from the back of a garbage truck and was tasked with assessing hazard level by identifying truck direction, bin lifter movement, and nearby people. Over the week, I learned Python for the first time, along with the OpenCV Computer Vision Library in order to identify behavior in the footage. I finished 3rd out of 142 registered participants.',
        },
      ],
    };
  }
    ...
    return (
      <div>
        ...
        {this.state.projects.map(element => (
          <div className={styles.project_entry}>
            ...
            <div className={styles.project_text}>
              ...
              <div className={styles.bullet_list}>
                {element.skills.map((e, index) => (
                  <div className={styles.bullets}>
                    {index !== 0 && <p className={styles.bullet}>&bull;</p>}{' '}
                    <p className={styles.project_languages}>{e}</p>
                  </div>
                ))}
              </div>
