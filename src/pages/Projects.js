  ...
  render(){
    ...
    <body class="container">
      ...
      <div class="body">
        ...
        {this.state.projects.map((element, index) =>  <div class="project_entry">
                                                        <div class="project_image_container">
                                                          <img class ="project_image" src={element.image} />
                                                        </div>
                                                        <div class="project_text">
                                                          <p class="project_name">{element.name}</p>
                                                          <p class="project_group">{element.group}</p>
                                                          <p class="date">{element.date}</p>
                                                          <div class="bullet_list">{element.skills.map((e, index) => <div class="bullets">{ index != 0 && <p class ="bullet">&bull;</p>} <p class="project_languages">{e}</p></div>)}</div>
                                                          <p class="project_description">{element.description}</p>
                                                        </div>
                                                      </div>)}
      </div>
      <Footer />
