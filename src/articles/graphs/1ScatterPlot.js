    ...
    d3.csv(this.props.data,
      ...
      (data) => {
        ...
        if(parseInt(salary,10) < 1000){
          ...
          var salary = "" + Number(parseInt(salary,10)/1000.0).toFixed(1) + "k"
        }else{
          var salary = "" + Number(parseInt(salary,10)/1000000.0).toFixed(1) + "m"
        }
        var followers = data[this.props.followerindex]
        if(parseInt(followers,10) < 1000){
          var followers = followers
        }else if(parseInt(followers,10) < 1000000){
          var followers = "" + Number(parseInt(followers,10)/1000.0).toFixed(1) + "k"
        }else{
          var followers = "" + Number(parseInt(followers,10)/1000000.0).toFixed(1) + "m"
        }
        if(a!=""&&b!=""){
          svg
            .append("g")
