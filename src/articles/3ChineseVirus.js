...
import Timeline from "./graphs3/Timeline.js";
import Timeline2 from "./graphs3/Timeline2.js";
import GoogleTrends from "./graphs3/GoogleTrends.js";
import MapChart from "./graphs3/MapChart.js";
import MapChart2 from "./graphs3/MapChart2.js";
...
class ChineseVirus extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            color: ['black','black'],
            dataOne: [],
            quotes: ["I am posting this on behalf of my dad. He’s a 71-year old Korean adoptee. Yesterday, he was chased out of a rural convenience store after asking to use the restroom while traveling along I-5 through California to get to Portland, Oregon.",
        ...
        <MathJax.Provider>
            <div class="everything">
                ...
                <div class="article-content">
                  <h2>Introduction</h2>
                  <p>For my final presentation in Expository Writing (ENG001), I decided that I wanted to focus on
                    visualizing various aspects of my argument in my final essay. I explored how <strong>Trump's use 
                    of the term 'Chinese virus' has led to the stigmatization and discrimination of Asian American 
                    communities during the United States COVID-19 crisis.</strong> My interest in Natural Language
                    Processing inspired me take this data visualization and exploration approach to this assignment.
                    In this presentation, I present the complete history of Trump's use of the term "Chinese virus" as well as quantify the effects it has had
                    on the public.
                  </p>
                  <h2>Trump's Language</h2>
                  <p>In order to understand the effects of Trump's rhetoric, it is important to first understand
                    how and when he has used "Chinese virus". I focused on looking at his press briefing
                    language as well as his Twitter account.
                  </p>
                  <p>Any mention of "Chinese virus" or "Wuhan virus" by Donald Trump in his 46 press briefings since
                    February 26, 2020 can be found on the timeline below. Transcripts from press briefings were found 
                    on <a href="https://www.rev.com/blog/transcripts?s=Trump">Rev</a>. Any of Trump's tweets regarding 
                    COVID-19 since January 24, 2020 are also displayed on the lower timeline 
                    with the use of "Chinese virus" colored in red. The dataset can be found
                    on <a href="http://www.trumptwitterarchive.com/archive">Trump Twitter Archive</a>.
                  </p>
                  <Timeline2 />
                  <Timeline />
                  <p>Trump began using the term on March 16th and vowed on March 23, 2020 that he would stop using it.
                    However, it is interesting to see that there have been instances where he has continued to use the term
                    in his press briefings. On March 26, he continued to defend his use of "Chinese virus", mentioning
                    in his press briefing how attaching location to diseases has been done in the past.
                  </p>
                  <h2>The Effects of Trump's Language</h2>
                  <p>It has only been one month since Trump began his use of "Chinese virus", making it difficult to obtain
                    large, complete datasets that reflect how the general population has been affected by his rhetoric. 
                    In my research paper, I argue that the danger of Trump's rhetoric is that some may put stock into 
                    his claims and allegations. In this portion, I wanted to look into how popular the term 
                    "Chinese virus" became after Trump used it which will give a sense of how widely used the term is.
                  </p>
                  <p>Google Trends is a great starting point in understanding the popularity of certain topics. It
                    provides data on how often a topic is searched for over time. Google Trends data is normalized, 
                  ...
                  <div class="google-trends-bottom">
                    ...
                    <GoogleTrends name="chineseVirusTrend" dataset={speechChineseVirus}/>
                  </div>
                  <p>The United States announced their first case of COVID-19 on January 20th, which can be used to 
                    explain the upticks in Google searches for "Coronavirus" and "Chinese Virus". "COVID-19" had not been
                    introduced by the World Health Organization until February 11, 2020, which can explain the lack
                    of popularity of the name until early March.</p>
                  <p>Note that "Chinese Virus" experienced a resurgence in popularity in the days after
                    Trump began using it despite the fact that interest in "Coronavirus" had begun to decline.
                    However, this data is quite unrepresentative as those who have Googled any of the above terms
                    demonstrate that they were actively seeking out recent information about the crisis. The data leaves out the section
                    of the population that isn't as caught up on recent events, and thus is more susceptible to misinformation.
                    The unrepresentative nature of the sample could be used to explain the sharp decline of the term
                    "Chinese virus" in Google Searches.
                  </p>
                  <h2>Effects of Trump's Language on Hate Crime Data</h2>
                  <p>In my research paper, I mention Russell Jeung and his anonymous reporting 
                    website, <a href="https://www.asianpacificpolicyandplanningcouncil.org/stop-aapi-hate/">STOP AAPI HATE</a>.
                    STOP AAPI Hate launched on March 19, 2020 and has received "1,135 reports in its first two weeks." 
                    In their biweekly reports, they release data regarding the type, location, and details of
                    the attacks. Shown below is the number of reported hate-crimes 
                    and <a href="https://github.com/CSSEGISandData/COVID-19">COVID-19 cases</a> by state as of April 1st.</p>
                  ...
                  <p>By comparing these two maps, it is apparent that there exists a correlation between how hard a state has been
                    hit by COVID-19 and the number of hate-crimes against Asians. In my essay, I argue that through hate-crime reporting,
                    measures can be put in place to mitigate the scapegoating of Asian Americans using data about the location
                    of these attacks. STOP AAPI Hate is a step in the right direction towards putting in place preventative measures
                    where they are most needed.
                  </p>
                  <p>No conclusions can be drawn regarding the extent to which Trump's language correlates with hate crime data as
                    STOP AAPI Hate is relatively new and has no data prior to when Trump began using "Chinese virus". However,
                    we can look to towards the published incident reports from STOP AAPI Hate. It is disheartening to see clear
                    references to "Chinese virus" or mentions of Trump specifically in some of these reports. Shown below are
                    some of the stories given by victims.
                  </p>
                  <Carousel>
                    {this.state.quotes.map((e) => <div class="quote-container">
                  ...
                  <p>
                    Trump is not single handedly responsible for the stigmatization of the Asian American community. COVID-19
                    has resulted in Asian American communities  to not only be concerned about their health, but also their
                    safety and place in society. While Trump is not the direct cause of these hate crimes, it is clear that his actions and
                    word choice have had noticeable impacts some of the hostile reactions to the virus.
                  </p>
